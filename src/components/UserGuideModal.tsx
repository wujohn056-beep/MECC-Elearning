    ...
    const zhContent = {
        ...
        sections: isLeader ? [
            ...
            },
            {
                ...
                desc: "多端体验，消息不延误：",
                bullets: [
                    "移动端 App 安装：扫码下载 Android APK 1.0.6+ 或加入 iOS TestFlight 1.1+，体验更流畅的原生操作。",
    ...
    const enContent = {
        ...
        sections: isLeader ? [
            ...
            },
            {
                ...
                bullets: [
                    "Mobile App Installation: Scan the QR code to download Android APK 1.0.6+ or join iOS TestFlight 1.1+.",
    ...
    const arContent = {
        ...
        sections: isLeader ? [
            ...
            },
            {
                ...
                bullets: [
                    "تطبيق الهاتف الجوال: امسح رمز QR لتحميل تطبيق Android APK 1.0.6+ أو الانضمام إلى iOS TestFlight 1.1+ لتجربة استخدام أسرع.",
