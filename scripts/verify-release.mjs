...
const sourceAssertions = [
  ...
  ['team progress resolves missing TL from current user directory', 'src/pages/LearningHub.tsx', ['allSystemUsers', 'resolveOfficialTeamTl', 'resolveTlForMember', "candidateRole !== 'tl'", 'officialTeamTl', 'teammateWithTl', "t('dashboard.unassigned_tl'"]],
