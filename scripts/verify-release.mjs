...
const sourceAssertions = [
  ...
  ['release workflow verifier exists', 'scripts/verify-release-workflow.mjs', ['Release workflow verified', 'needs: verify-release', "if: github.event_name != 'pull_request'", 'Build current shell for smoke comparison', 'PROD_SMOKE_RETRIES', 'PROD_SMOKE_RETRY_DELAY_MS']],
