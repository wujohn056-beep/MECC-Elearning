...
const sourceAssertions = [
  ...
  ['manual QA evidence validator exists', 'scripts/validate-manual-qa-evidence.mjs', ['Fully verified must be Yes', 'Android push must be configured for full verification', 'Android push tap opens the correct recording/task/campaign page', 'Manual QA evidence validated']],
  ['manual QA evidence validator verifier exists', 'scripts/verify-manual-qa-evidence-validator.mjs', ['Manual QA evidence validator verified', 'Expected invalid evidence with a Fail row to be rejected', 'Expected invalid evidence with a Not configured push row to be rejected']],
