...
const sourceAssertions = [
  ...
  ['recordings manager transcript viewer is large readable modal', 'src/pages/admin/RecordingsManager.tsx', ['max-w-[min(96vw,1280px)]', 'h-[94vh]', 'max-h-[94vh]', 'text-base md:text-lg', 'min-h-full']],
