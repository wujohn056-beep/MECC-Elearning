...
const passRows = [
  ...
  ['Policy App push notification is received', 'Pass', 'Pixel 8 policy notification 15:33'],
  ['Policy App push opens the policy detail page', 'Pass', 'https://learning.mecloudhub.com/policies?policyId=policy-321'],
  ['Brand App push notification is received', 'Pass', 'Pixel 8 brand notification 15:34'],
  ['Brand App push opens the brand detail page', 'Pass', 'https://learning.mecloudhub.com/brands?policyId=brand-654'],
