...
const exactPassRows = [
  ...
  'Policy App push notification is received',
  'Policy App push opens the policy detail page',
  'Brand App push notification is received',
  'Brand App push opens the brand detail page',
